import {HeadMenu, ImgWindow, System} from "@/model/System";
...
const SYSTEM = {
    ...
    getters: {
        gettersHeadMenuInfo(state: System, params: null, rootState: System) {
            // let friend = rootState.friend.friendlist.find(friend => friend.username === state.headMenu.username);
            // return friend;
        },
    },
    mutations: {
        systemMutationsSetSystemFileIcon(state: System, value: string) {
            state.systemFileIcon = value;
        },
        systemMutationsShowImgWindow(state: System, value: ImgWindow) {
        ...
        systemMutationsSetNetwork(state: System, value: boolean) {
            state.network = value;
        },
        systemMutationsSetWindowWidth(state: System, value: number) {
            state.windowWidth = value;
        },
        systemMutationsSetWindowHeight(state: System, value: number) {
            state.windowHeight = value;
        },
        // 获取搜索值
        systemMutationsSearch(state: System, value: string) {
            state.searchText = value
        },
        systemMutationsSetHeadMenu(state: System, value: HeadMenu) {
